            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1 leading-relaxed">
                ...
                <Share
                  ...
                  aria-label={t.install.iosShareLabel}
                />
                {t.install.iosInstructionAfter}<span className="font-medium text-zinc-700 dark:text-zinc-300">{t.install.iosActionLabel}</span>{t.install.iosInstructionEnd}
              </p>
            </div>
          </div>
        )}
