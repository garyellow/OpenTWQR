...
export const AmountInput = ({ value, onChange, maxAmount = 200000 }: AmountInputProps) => {
  ...
  const digitBtnClass =
    'h-14 rounded-2xl text-2xl font-medium text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100 dark:hover:bg-zinc-800 active:bg-zinc-200 dark:active:bg-zinc-700 active:scale-95 transition-all flex items-center justify-center';
    ...
    <div className="w-full max-w-sm mx-auto flex flex-col gap-3">
      ...
      <div role="group" aria-label="數字鍵盤" className="grid grid-cols-3 gap-x-4 gap-y-1.5 select-none px-4 shrink-0">
        ...
        <button
          ...
          aria-label="刪除一位數字"
          className="h-14 rounded-2xl text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 active:bg-zinc-200 dark:active:bg-zinc-700 active:scale-95 transition-all flex items-center justify-center"
        >
