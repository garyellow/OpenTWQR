  ...
  return (
    <div className="fixed inset-0 z-85">
      ...
      <div
        ...
        aria-modal="true"
        aria-label="分享方式"
        className={`pointer-events-auto relative w-full max-w-sm bg-white dark:bg-zinc-900 rounded-4xl border border-zinc-200 dark:border-zinc-800 shadow-2xl overflow-hidden overscroll-contain motion-reduce:animate-none ${
