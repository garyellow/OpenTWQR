  ...
  return (
    <div className="fixed inset-0 z-85">
      ...
      <div
        ...
        className={`pointer-events-auto relative w-full max-w-sm bg-white dark:bg-zinc-900 rounded-4xl border border-zinc-200 dark:border-zinc-800 shadow-2xl motion-reduce:animate-none p-6 overflow-y-auto max-h-[calc(100svh-2.5rem)] ${
