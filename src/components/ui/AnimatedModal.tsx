    ...
    <div className={`fixed inset-0 ${overlayClass}`}>
      ...
      <div className="absolute inset-0 flex items-center justify-center p-5 pointer-events-none">
        <div
          ...
          className={`pointer-events-auto w-full bg-white dark:bg-zinc-900 rounded-4xl shadow-2xl border border-zinc-200 dark:border-zinc-800 overscroll-contain motion-reduce:animate-none ${
            isClosing
