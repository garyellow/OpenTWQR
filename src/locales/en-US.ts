...
const enUS: Translations = {
  ...
  urlScheme: {
    ...
    entryRow: 'Manage Transfer Links',
    entryDesc: 'Set up to open your transfer app with one tap after scanning',
    ...
    addBank: 'Add Transfer Link',
    addLabel: 'Add',
    editTitle: 'Edit Transfer Link',
    addTitle: 'Add Transfer Link',
    ...
    deleteTitle: 'Remove Transfer Link',
    deleteConfirm: 'Are you sure you want to remove this transfer link configuration? This cannot be undone.',
    save: 'Save',
    testLabel: 'Test',
    testTitle: 'Test Transfer Link',
    testDesc: 'Fill in test data to verify the URL integration opens your transfer app correctly.',
