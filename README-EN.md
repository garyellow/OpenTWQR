...
- **Multi-Account Management** — Save multiple accounts with nicknames and use the same account selector on the Receive page and inside the payment QR modal; tap to open the account sheet, or switch quickly with QR-side arrows, swipe, or keyboard
